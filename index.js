...
var fs       = require('fs'),
    ...
    repos    = {
        ...
        magsdk: {
            ...
            'component-check-list':  {name: 'mag-component-check-list', url: 'git@192.168.1.222:/web/magsdk/component-check-list.git'},
            ...
            'component-list':        {name: 'mag-component-list', url: 'git@192.168.1.222:/web/magsdk/component-list.git'},
            ...
            'component-scroll-area': {name: 'mag-component-scroll-area', url: 'git@192.168.1.222:/web/magsdk/component-scroll-area.git'},
            'component-value-list':  {name: 'mag-component-value-list', url: 'git@192.168.1.222:/web/magsdk/component-value-list.git'},
