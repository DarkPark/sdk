...
spa=(app boilerplate component component-page develop dom gettext gulp gulp-jade gulp-lint gulp-pack gulp-repl gulp-sass gulp-webpack keys preloader request router)
