...
spa=(app boilerplate component component-page develop dom gettext gulp gulp-gettext gulp-jade gulp-lint gulp-pack gulp-repl gulp-sass gulp-static gulp-webpack keys preloader request router)
