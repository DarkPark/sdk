...
module.exports = {
    cjssdk: {
        ...
        'gettext':          {name: 'cjs-gettext', url: 'git@github.com:cjssdk/gettext.git'},
    ...
    cli: {
        'node-runner': {name: 'node-runner', url: 'git@github.com:DarkPark/node-runner.git'}
    },
    magsdk: {
        'app':                        {name: 'mag-app', url: 'git@github.com:magsdk/app.git'},
        'boilerplate':                {name: null, url: 'git@github.com:magsdk/boilerplate.git'},
        'component-check-list':       {name: 'mag-component-check-list', url: 'git@github.com:magsdk/component-check-list.git'},
        'component-footer':           {name: 'mag-component-footer', url: 'git@github.com:magsdk/component-footer.git'},
        'component-layout':           {name: 'mag-component-layout', url: 'git@github.com:magsdk/component-layout.git'},
        'component-layout-list':      {name: 'mag-component-layout-list', url: 'git@github.com:magsdk/component-layout-list.git'},
        'component-list':             {name: 'mag-component-list', url: 'git@github.com:magsdk/component-list.git'},
        'component-modal':            {name: 'mag-component-modal', url: 'git@github.com:magsdk/component-modal.git'},
        'component-modal-check-list': {name: 'mag-component-modal-check-list', url: 'git@github.com:magsdk/component-modal-check-list.git'},
        'component-panel':            {name: 'mag-component-panel', url: 'git@github.com:magsdk/component-panel.git'},
        'component-panel-set':        {name: 'mag-component-panel-set', url: 'git@github.com:magsdk/component-panel-set.git'},
        'component-radio-list':       {name: 'mag-component-radio-list', url: 'git@github.com:magsdk/component-radio-list.git'},
        'component-scroll-area':      {name: 'mag-component-scroll-area', url: 'git@github.com:magsdk/component-scroll-area.git'},
        'component-value-list':       {name: 'mag-component-value-list', url: 'git@github.com:magsdk/component-value-list.git'},
        'data-cacher':                {name: 'mag-data-cacher', url: 'git@github.com:magsdk/data-cacher.git'},
        'eslint-config':              {name: 'mag-eslint-config', url: 'git@github.com:magsdk/eslint-config.git'},
        'magsdk':                     {name: 'magsdk', url: 'git@github.com:magsdk/magsdk.git'},
        'plugin-css':                 {name: 'mag-plugin-css', url: 'git@github.com:magsdk/plugin-css.git'}
    },
    magcore: {
    ...
    spasdk: {
        ...
        'component-progress-bar': {name: 'spa-component-progress-bar', url: 'git@github.com:spasdk/component-progress-bar.git'},
        'component-scrollbar':    {name: 'spa-component-scrollbar', url: 'git@github.com:spasdk/component-scrollbar.git'},
        'component-tab':          {name: 'spa-component-tab', url: 'git@github.com:spasdk/component-tab.git'},
        'component-widget':       {name: 'spa-component-widget', url: 'git@github.com:spasdk/component-widget.git'},
        ...
        'task-config':            {name: 'spa-task-config', url: 'git@github.com:spasdk/task-config.git'},
        'tasks':                  {name: 'spa-tasks', url: 'git@github.com:spasdk/tasks.git'},
    ...
    stbsdk: {
        ...
        'component-modal':     {name: 'stb-component-modal', url: 'git@github.com:stbsdk/component-modal.git'},
